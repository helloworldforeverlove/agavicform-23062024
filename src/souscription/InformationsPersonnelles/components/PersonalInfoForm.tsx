...
const PersonalInfoForm: React.FC = () => {
    ...
    useEffect(() => {
        const fetchResponse = async () => {
            ...
            const connuPatriLife = await getResponse(36); // 'connuPatriLife' is step 36
    ...
    const validateForm = () => {
        const newErrors = {
            ...
            connuPatriLife: formValues.connuPatriLife === '',
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (validateForm()) {
            ...
            await updateResponse(36, formValues.connuPatriLife);
            ...
            await saveDataToDatabase({
                ...
                step36: formValues.connuPatriLife,
        ...
        <ChakraProvider theme={theme}>
            ...
            <Box p={5} maxW="1000px" mx="auto">
                ...
                <VStack spacing={4} align="stretch" mx="auto">
                    ...
                    <FormControl isInvalid={errors.connuPatriLife}>
                        <Text fontSize="md" mb={2}>Comment avez-vous connu PatriLife ?</Text>
                        <CustomSelect
                            name="connuPatriLife"
                            value={formValues.connuPatriLife}
                            onChange={handleInputChange}
                            mb={4}
                        >
                            <option value="">Veuillez sélectionner</option>
                        ...
                        {errors.connuPatriLife && (
                            <Alert status="warning" mt={2} backgroundColor="orange.100" borderRadius="md">
                                <AlertIcon color="orange.400" />
                                <AlertDescription color="orange.600">Veuillez sélectionner une option pour Comment avez-vous connu PatriLife ?.</AlertDescription>
                            </Alert>
                        )}
                    </FormControl>
