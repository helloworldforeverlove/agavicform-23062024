...
const PlacementAssuranceVie: React.FC = () => {
    ...
    return (
        <ChakraProvider theme={theme}>
            <StepperWithSubStepCounter currentStep={1} currentSubStep={16} totalSubSteps={25} title="Avez-vous déjà placé de l'argent sur un contrat d'assurance-vie, un compte-titres ou un plan d'épargne en actions (PEA) ?" />
