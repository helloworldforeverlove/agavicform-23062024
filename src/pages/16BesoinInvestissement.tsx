...
const BesoinInvestissement: React.FC = () => {
    ...
    return (
        <ChakraProvider theme={theme}>
            <StepperWithSubStepCounter currentStep={1} currentSubStep={15} totalSubSteps={24} title="Pourriez-vous avoir besoin de la moitié de votre investissement avant 25 ans ?" />
