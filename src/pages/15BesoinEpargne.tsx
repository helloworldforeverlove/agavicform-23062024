...
const BesoinEpargne: React.FC = () => {
    ...
    return (
        <ChakraProvider theme={theme}>
            <StepperWithSubStepCounter currentStep={1} currentSubStep={14} totalSubSteps={25} title="Pourriez-vous avoir besoin de toute l'épargne placée chez PatriLife d'ici 2 ans ?" />
